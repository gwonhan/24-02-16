...
public class User {
    ...
    *  2. 매개변수 있는 생성자의 경우 매개변수로 전달받은 값으로 필드를 초기화하여
    ...
    *  매개변수가 있는 생성자가 한 개라도 존재하는 경우에는 가본 생성자를 자동으로 추가해주지 않기 때문에
    *  기본 생성자가 필요한 경우에는 반드시 명시적으로 작성해 주어야 한다.*/
    ...
    public User(String id, String pwd, String name){
        ...
        /*필기. 매개변수 있는 생성자의 주목적은 인스턴스 생성 시점에 매개변수로 전달
        ...
        System.out.println("User 클래스의 아이디 패스워드 이름을 초기화 하는 생성자 호출함...");
