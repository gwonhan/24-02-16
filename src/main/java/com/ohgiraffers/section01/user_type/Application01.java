...
public class Application01 {
    public static void main(String[] args) {
        ...
        * */
        ...
        /*필기.
        *  이렇게 각가의 변수로 관리하게 되면 여러가지 단점이 있다.
        ...
        *  */
        ...
        Member member = new Member();       //클래스 자체가 자료형이다.

        /*목차. 2-2. 생성된 인스턴스의 초기값 확인하기.*/

        /*필기.
        *  이렇게 위에서처럼 객체를 생성하고 나면, 서로 다른 자료형들은 하나의 member 라는 변수명으로 관리할 수 있도록
        *  공간을 생성한 것이다.
        *  heap 이라는 공간에 생성되기 때문에 jvm 이 제공하는 기본값들로 초기화 된다.
        *  */

        /*필기.
        *  필드에 접근하기 위해서는 레퍼런스 변수명.(주소값을 가지고 있는 변수). 필드명 <- 이렇게 접근한다.
        *  ' . ' 은 참조 연산자라고 하는데, 레처런스 변수가 참조하고 있는 주소로 접근한다 라는 의미.
        *  각 공간은 필드명으로 접근한다.
        *   */
        ...
        System.out.println("변경 후 mwmber.id  = " + member.id);
        System.out.println("변경 후member.pwd = " + member.pwd);
