...
public class MemberDTO {
    ...
    *  필드에 접근해서 기록도니 값을 return을 이용하여 반환하며, 이 때 반환 타입은 값의 자료형과 일치.
    *  [표현식]
    *  public 반환형 get필드명(){
    *  return 반환값;
    *  }
    ...
    *  }*/
    ...
    public double getWeight(){return getWeight();}

    /*필기. boolean 의 접근자는 get 으로 시작하지 않고 is 로 시작하는 것이 일반적으로 관례이다.*/

    public  boolean isActivated(){return isActivated;}

    /*필기.
    *  데이터를 주로 다루는 객체의 경우 행위를 추상화하지 않고
    *  미리 모든 필드에 접근 가능성을 염두해두고 적성해두는 관례로 인해 현재도 많이 사용하고 있다.
    *   */
